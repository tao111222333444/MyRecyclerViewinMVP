...
import com.hangzhou.myrecyclerviewinmvp.base.BaseActivity;
import com.hangzhou.myrecyclerviewinmvp.utils.AutoAdaptionScreenUtil;
...
public class MobileAppActivity extends BaseActivity {
    ...
    private void initializeView() {
        ...
        mFragments.add(getMobileAppFragment(MobileAppModel.TYPE_1));
        mFragments.add(getMobileAppFragment(MobileAppModel.TYPE_2));
        mFragments.add(getMobileAppFragment(MobileAppModel.TYPE_3));
